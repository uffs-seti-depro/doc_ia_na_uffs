...
const projectsData = {
  "projects": [
    ...
    {
      "id": "P6",
      "title": "Captação de recursos e viabilização do uso",
      "description": "Desenvolvimento de estratégias para captação de recursos financeiros e humanos necessários para implementação e sustentação das soluções de IA e RPA.",
      "isActive": true,
