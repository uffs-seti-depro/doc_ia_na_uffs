...
const projectsData = {
  "projects": [
    ...
    {
      "id": "P9",
      "title": "P9 - Instalação e implantação da Infraestrutura de TI",
    ...
    {
      "id": "P10",
      "title": "P10 - Pipeline de dados para treinamento dos modelos de IA",
    ...
    {
      "id": "P11",
      "title": "P11 - Digitalização e gestão documental",
    ...
    {
      "id": "P12",
      "title": "P12 - Webchat para interação com assistentes virtuais",
    ...
    {
      "id": "P13",
      "title": "P13 - Assistente virtual para regras de negócio e regulamentos",
    ...
    {
      "id": "P14",
      "title": "P14 - Assistente virtual departamentalizado",
    ...
    {
      "id": "P15",
      "title": "P15 - Assistente virtual para produção generativa de documentos",
    ...
    {
      "id": "P16",
      "title": "P16 - Agentes computacionais",
    ...
    {
      "id": "P17",
      "title": "P17 - Plataforma de Dados Institucionais (API.Dados)",
    ...
    {
      "id": "P18",
      "title": "P18 - Ferramenta de Business Analytics",
    ...
    {
      "id": "P20",
      "title": "P20 - Integrador Compras-Contratos-Financeiro",
    ...
    {
      "id": "P23",
      "title": "P23 - Automatização do AFD",
    ...
    {
      "id": "P24",
      "title": "P24 - Automatização do SIAPE/SIGEPE",
    ...
    {
      "id": "P25",
      "title": "P25 - Projetos piloto e experimentação",
    ...
    {
      "id": "P26",
      "title": "P26 - Divulgação científica e eventos",
